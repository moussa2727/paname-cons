...
const RendezVous: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message.includes('déjà un rendez-vous en cours')) {
    ...
    <div ref={stepRef} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {showDestinationOther && (
          <div className="space-y-2">
            <label htmlFor="destinationAutre" className="text-sm font-medium text-gray-700">
        ...
        <div className="space-y-2">
          <label htmlFor="niveauEtude" className="text-sm font-medium text-gray-700">
            Niveau d'étude *
          </label>
        ...
        {showFiliereOther && (
          <div className="space-y-2">
            <label htmlFor="filiereAutre" className="text-sm font-medium text-gray-700">
