  ...
  const formationsData = [
    {
      ...
      description: 'Formations de qualité à tarifs accessibles (170€ à 3 770€/an)',
            ...
            >
              ...
              <div className='p-6 border-b border-sky-100'>
                <div className='flex items-center space-x-4'>
                  <div className={`p-3 ${formation.iconBg} rounded-xl group-hover:scale-110 transition-transform duration-300`}>
                    {formation.icon}
                  </div>
                  <div>
                ...
                {formation.items.map((item, index) => (
                  ...
                  >
                    <div className='flex-shrink-0 mt-0.5'>
                      {item.icon || <CheckCircle2 className='w-5 h-5 text-sky-500' />}
                    </div>
