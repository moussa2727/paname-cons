          ...
          >
            ...
            <div className="relative px-4 py-5 border-b border-sky-200 bg-linear-to-r from-sky-50 to-blue-50">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={onToggle}
                className="absolute right-5 top-1/4 -translate-y-1/2 p-2 bg-linear-to-br from-sky-500 to-blue-600 text-white rounded-full shadow-lg hover:shadow-xl hover:from-sky-600 hover:to-blue-700 transition-all duration-200 border-2 border-white group z-10"
