...
const Partners = () => {
  ...
  return (
    <section className='py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-sky-50 via-white to-blue-50 overflow-hidden'>
      <div className='max-w-7xl mx-auto'>
        ...
        >
          ...
          <div className='flex justify-center items-center gap-2 mt-10'>
            {Array.from({ length: Math.min(10, maxIndex + 1) }).map(
              (_, index) => (
                <motion.button
                  key={index}
                  ...
                  whileHover={{
                    backgroundColor:
                      index !== currentIndex ? '#9ca3af' : undefined,
                    scale: 1.2,
                  }}
                  whileTap={{ scale: 0.9 }}
                  animate={{
