...
const Notfound: React.FC<NotFoundProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-linear-to-b from-sky-50 to-blue-100 flex items-center justify-center px-4 ${className}`}
      >
        <div className="max-w-lg w-full text-center">
          {/* Icône 404 avec animation légère */}
          <div className="mb-8 relative">
            <div className="text-9xl font-bold text-blue-300/30 select-none">
              404
            </div>
          ...
          {/* Titre */}
          <h1 className="text-4xl font-light text-blue-900 mb-4">{title}</h1>

          {/* Message */}
          <p className="text-blue-700/80 mb-8 text-lg">{message}</p>
