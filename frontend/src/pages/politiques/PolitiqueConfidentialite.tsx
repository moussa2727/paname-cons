  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Politique de confidentialité de Paname Consulting - Protection de vos données personnelles" />
        {/* noindex, nofollow */}
            ...
            <div className="px-8 py-8 space-y-8">
              <section className="space-y-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Paname Consulting, s'engage à protéger la vie privée de ses utilisateurs. 
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <h3 className="text-lg font-medium text-gray-800">1.1 Informations personnelles</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-gray-800">1.2 Données techniques</h3>
                    <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                      <li>Adresse IP</li>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
                  ...
                  <li>Les autorités consulaires ou d'immigration (si nécessaire pour vos procédures)</li>
                  <li>Nos prestataires de services techniques (hébergement, email, etc.)</li>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
                  ...
                  <li><strong>Droit de rectification :</strong> Mettre à jour vos informations</li>
