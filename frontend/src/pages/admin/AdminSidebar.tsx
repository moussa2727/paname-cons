                    ...
                    <Link
                      ...
                      className={`flex items-center rounded-xl transition-all duration-200 group ${
                        isCollapsed
                          ...
                          : 'space-x-4 px-4 py-3'
                      } ${getActiveItemClass(item.basePath)} focus:ring-0 focus:outline-none focus:border-sky-300 border border-transparent`}
                ...
                <div className='space-y-1'>
                  {menuItems.map(item => (
                    <Link
                      ...
                      className={`flex items-center space-x-4 px-4 py-4 rounded-xl transition-all duration-200 ${getActiveItemClass(item.basePath)} focus:ring-0 focus:outline-none focus:border-sky-300 border border-transparent`}
                    >
                      <div
                        className={`${
                          isActivePath(item.basePath)
          ...
          <div className='bg-white rounded-2xl shadow-xl w-full max-w-md transform transition-all'>
            ...
            <div className='p-6'>
              ...
              <p className='text-sm text-slate-500 text-center'>
                Cette action déconnectera tous les utilisateurs (sauf les
