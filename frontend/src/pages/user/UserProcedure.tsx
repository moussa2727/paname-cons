                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-gray-600 text-sm space-y-1">
                            ...
                            <p className="text-xs">
                              Créée le {formatProcedureDate(procedure.createdAt)}
                            </p>
                          </div>
                        </div>
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-xs text-gray-500 mt-1">
                                  <span>
                                    Démarrée le {formatProcedureDate(step.dateCreation)}
                                  </span>
                                  {step.dateMaj && step.statut !== StepStatus.PENDING && (
                                    <span>
                                      {' '}
                                      • Mise à jour le {formatProcedureDate(step.dateMaj)}
                                    </span>
                                  )}
                                </div>
                                {step.raisonRefus && (
                        ...
                        <div className="bg-sky-50 rounded-xl p-4 border border-sky-200">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between py-1">
                              ...
                              <span className="text-gray-800 font-medium">
                                {typeof selectedProcedure.rendezVousId === 'object' &&
                ...
                <section className="mb-6">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-4 space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedProcedure.email}</span>
                    </div>
                    {selectedProcedure.telephone && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">Téléphone</span>
                        <span className="font-medium">{selectedProcedure.telephone}</span>
                      </div>
                    )}
                  </div>
                </section>
                ...
                <section className="mb-6">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-4 space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedProcedure.niveauEtude}</span>
                    </div>
                    <div className="flex justify-between">
