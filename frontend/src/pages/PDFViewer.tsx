    ...
    return (
      <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
        <div className='bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center'>
          ...
          <h2 className='text-2xl font-bold text-gray-800 mb-4'>Document en cours de préparation</h2>
          <p className='text-gray-600 mb-6'>
            Nous faisons tout notre possible pour rendre ce document disponible dans les plus brefs délais. 
            Nos équipes travaillent actuellement à sa finalisation.
          </p>
          <div className='bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6'>
            <p className='text-sm text-amber-800'>
              <strong>Bientôt disponible :</strong> Ce document sera mis à jour dès que possible.
            </p>
          </div>
          <button
            onClick={() => navigate(-1)}
